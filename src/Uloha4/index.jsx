...
const Pozdrav = ({ jmenoVeCtvrtemPade, jmenoVPatemPade }) => {
	return ( 								
			...
			</button>					// POZOR alert je s malým a
	)
}
...
const Uloha4 = () => {
	return (				// BACHA tady musí být závorka!!!
	<> 
		<Pozdrav jmenoVeCtvrtemPade="Luďka" jmenoVPatemPade="Luďku" />
		<Pozdrav jmenoVeCtvrtemPade="Josie" jmenoVPatemPade="Jo" />
		<Pozdrav jmenoVeCtvrtemPade="Toma" jmenoVPatemPade="Tome" />
	</> 
	)
}
